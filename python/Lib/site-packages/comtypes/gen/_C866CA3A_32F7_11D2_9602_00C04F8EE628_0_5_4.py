...
__all__ = [
    'ISpRecognizer3', 'DISPID_SLWWord', 'SPPS_RESERVED4',
    'DISPID_SRCERequestUI', 'ISpNotifySink', 'SINoSignal',
    'SPPS_Noun', 'DISPID_SPEEngineConfidence', 'tagSTATSTG',
    'SPEI_REQUEST_UI', 'DISPID_SGRSTsCount',
    'ISpeechPhraseProperties', '_ISpeechRecoContextEvents',
    'eLEXTYPE_PRIVATE10', 'DISPID_SDKOpenKey',
    'ISpeechAudioBufferInfo', 'SAFTCCITT_ALaw_11kHzMono',
    'ISpRecoGrammar2', 'eLEXTYPE_PRIVATE5',
    'IInternetSecurityMgrSite', 'DISPID_SDKDeleteKey', 'SDTAudio',
    'SGSEnabled', 'IEnumString',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPDKL_CurrentConfig',
    'SPEI_END_SR_STREAM', 'DISPID_SLGenerationId', 'SVEAllEvents',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRRAlternates',
    'SAFT16kHz8BitStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'eLEXTYPE_PRIVATE18', 'eLEXTYPE_PRIVATE20', 'SPFM_CREATE_ALWAYS',
    'SVF_Emphasis', 'DISPID_SVEStreamEnd', 'SPSTREAMFORMATTYPE',
    'SpMemoryStream', 'DISPID_SPIRule', 'DISPID_SRCBookmark',
    ...
    'SAFTCCITT_uLaw_11kHzMono', 'SAFTADPCM_44kHzMono', 'SPSMF_UPS',
    'SpeechTokenKeyAttributes', 'DISPID_SCSBaseStream',
    'DISPID_SLWPronunciations', 'SPGS_ENABLED', 'STSF_AppData',
    'DISPID_SPIStartTime', 'IStream', 'DISPID_SGRName',
    'SPAR_Unknown', 'DISPID_SPISaveToMemory', 'DISPID_SPRsCount',
    'SVSFPersistXML', 'DISPID_SPPsItem', 'SRSInactiveWithPurge',
    'SAFT11kHz8BitStereo', 'ISpeechMemoryStream',
    'DISPID_SRRTStreamTime', 'SPBINARYGRAMMAR',
    'DISPID_SRCEAudioLevel', 'DISPID_SRRRecoContext',
    'DISPID_SGRSAddWordTransition', 'SECFIgnoreKanaType',
    'SRTAutopause', 'DISPID_SDKCreateKey', 'SPEI_WORD_BOUNDARY',
    ...
    'SDA_One_Trailing_Space', 'SpeechRegistryUserRoot', 'SpShortcut',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SOTCEnumerateTokens', 'SPAS_STOP', 'SPRST_ACTIVE_ALWAYS',
    'ISpGrammarBuilder', 'SPSLMA', 'ISpeechObjectTokenCategory',
    'SPSNoun', 'SPPS_Verb', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRCESoundEnd', 'SPBO_TIME_UNITS', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRGSetWordSequenceData',
    'SPINTERFERENCE_TOOQUIET', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRSTsItem', 'SPCATEGORYTYPE', 'DISPID_SpeechVoiceStatus',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SGRAttributes',
    'DISPID_SRGCmdLoadFromMemory', 'SREStreamStart',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechDisplayAttributes', 'DISPID_SPIEngineId',
    'DISPID_SPPs_NewEnum', 'ISpVoice', 'eLEXTYPE_PRIVATE16',
    'eLEXTYPE_PRIVATE17', 'DISPID_SRSAudioStatus',
    'SpCompressedLexicon', 'ISpeechXMLRecoResult',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRCEEnginePrivate',
    'eLEXTYPE_PRIVATE1', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SABIEventBias', 'SAFT24kHz16BitStereo',
    'DISPID_SVESentenceBoundary', 'SPRST_INACTIVE_WITH_PURGE',
    'SGDSInactive', 'DISPID_SMSSetData', 'DISPID_SABIMinNotification',
    'SPEI_START_INPUT_STREAM', 'SPWORD', 'SGLexicalNoSpecialChars',
    'SDKLCurrentUser', 'eLEXTYPE_PRIVATE11', 'SECFIgnoreWidth',
    'ISpLexicon', 'DISPID_SREmulateRecognition',
    'DISPID_SRRSpeakAudio', 'SPSERIALIZEDRESULT',
    'DISPID_SVDisplayUI', 'SPPHRASERULE', 'SAFT11kHz16BitMono',
    'DISPID_SBSWrite', 'DISPID_SpeechRecognizer',
    ...
    'SAFTDefault', 'SP_VISEME_0', 'SpInprocRecognizer',
    'DISPID_SpeechWaveFormatEx', 'SREHypothesis',
    'DISPID_SPRuleFirstElement', 'SP_VISEME_9', 'DISPID_SRStatus',
    'DISPID_SMSADeviceId', 'SVP_5', 'DISPID_SLGetGenerationChange',
    'SINone', 'DISPID_SPEDisplayAttributes', 'ISpeechPhraseElement',
    'DISPID_SLAddPronunciationByPhoneIds', 'SGDSActiveWithAutoPause',
    'SVP_7', 'SVP_10', 'eLEXTYPE_PRIVATE7', 'DISPID_SRRTLength',
    'SPEI_FALSE_RECOGNITION', 'ISpeechRecoResultDispatch',
    'DISPID_SPIAudioSizeBytes', 'SPEI_RESERVED5', 'SECFDefault',
    'STCInprocServer', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SGRSTPropertyName', 'DISPID_SVEViseme', 'SSTTWildcard',
    'SAFT44kHz16BitStereo', 'SpeechVisemeType', 'ISpRecoContext2',
    'DISPID_SFSClose', 'SpeechAudioState', 'DISPID_SRDisplayUI',
    'DISPID_SGRAddResource', 'DISPID_SGRAddState',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPIAudioStreamPosition',
    'SP_VISEME_19', 'DISPID_SMSALineId', 'DISPID_SDKSetBinaryValue',
    'ISpeechRecoContext', 'DISPID_SDKSetStringValue',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechCategoryRecognizers', 'DISPID_SOTCGetDataKey',
    'ISpeechLexiconWords', 'SpeechAudioProperties',
    'SWPKnownWordPronounceable', 'SPPHRASE',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechGrammarRules',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SASCurrentDevicePosition',
    'Speech_StreamPos_Asap', 'SVEStartInputStream', 'SPLO_STATIC',
    'SPRST_INACTIVE', 'eLEXTYPE_PRIVATE14', 'SDTDisplayText',
    'DISPID_SPAsCount', 'DISPID_SLGetPronunciations',
    'DISPID_SRCEPhraseStart', 'SPSHT_Unknown', 'DISPID_SPPConfidence',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechVoice',
    'SAFTNonStandardFormat', 'DISPID_SPIElements', 'DISPID_SOTCSetId',
    'SPPS_RESERVED1', 'SpeechRuleState', 'SPINTERFERENCE',
    'DISPID_SRGState', 'SpeechVoiceSpeakFlags',
    'SPINTERFERENCE_TOOLOUD', 'DISPIDSPTSI_SelectionOffset',
    'SPEI_START_SR_STREAM', 'SpMMAudioOut', 'SpeechLoadOption',
    'STCLocalServer', 'SpeechVoicePriority', 'eLEXTYPE_PRIVATE15',
    'SECFEmulateResult', 'SREPrivate', 'ISpPhoneConverter',
    'SPEI_SENTENCE_BOUNDARY', 'SPRULESTATE', 'SPRECORESULTTIMES',
    'DISPID_SGRsAdd', 'SpeechGrammarTagDictation', 'SPEI_UNDEFINED',
    ...
    'DISPID_SPEDisplayText', 'DISPID_SRCEAdaptation',
    'ISpeechPhraseProperty', 'SPSFunction', 'SSSPTRelativeToEnd',
    'DISPIDSPTSI_ActiveLength', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpLexicon', 'SAFT8kHz8BitMono', 'DISPID_SpeechRecognizerStatus',
    'SPRECOGNIZERSTATUS', 'DISPID_SpeechLexiconProns',
    'SPTEXTSELECTIONINFO', 'SP_VISEME_5', 'DISPID_SOTDataKey',
    'SP_VISEME_17', 'SPSMF_SAPI_PROPERTIES', 'SVSFParseAutodetect',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SGRSTransitions',
    'DISPID_SPRs_NewEnum', 'SVP_13', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVEEnginePrivate', 'SPGRAMMARSTATE',
    'DISPID_SOTGetStorageFileName', 'SpeechEngineProperties',
    'DISPID_SRCCreateGrammar', 'DISPID_SAStatus',
    'DISPID_SVIsUISupported', 'SpeechGrammarTagWildcard',
    'SPSHORTCUTTYPE', 'SPWORDPRONOUNCEABLE', 'SITooLoud', 'SAFTText',
    'ISpRecognizer2', 'DISPID_SpeechMemoryStream', 'SVEBookmark',
    'DISPID_SVPause', 'SVP_15', 'SpeechRunState', 'DISPID_SGRsCount',
    'SGLexical', 'SPEI_RECO_STATE_CHANGE', 'SpResourceManager',
    'SREPhraseStart', 'DISPID_SPRuleName',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRGCmdSetRuleState',
    'SREAllEvents', 'SVF_None', 'SVP_12', 'eLEXTYPE_PRIVATE2',
    'SAFT11kHz16BitStereo', 'eLEXTYPE_RESERVED10', 'SPVISEMES',
    'SAFT24kHz8BitMono', 'DISPID_SPERequiredConfidence', 'SLODynamic',
    'SPPROPERTYINFO', 'DISPID_SVGetAudioOutputs', 'SVSFParseSapi',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SVEBookmark',
    'DISPID_SVEPhoneme', 'DISPID_SRCCmdMaxAlternates', 'SLOStatic',
    'DISPID_SpeechAudio', 'SVP_6',
    ...
    'SPEI_PHONEME', 'SRAInterpreter', 'SPEI_RESERVED6', 'SVP_2',
    'SpeechStreamSeekPositionType', 'ISpeechPhraseRule',
    '_SPAUDIOSTATE', 'SPEI_SOUND_END', 'SPSHT_EMAIL',
    'SAFT12kHz8BitStereo', 'ISpeechResourceLoader', 'DISPID_SPEsItem',
    'SPSHORTCUTPAIR', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRCResume',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SVEventInterests',
    'SITooFast', 'SpeechVisemeFeature',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPRULE', 'SPSUnknown',
    'SPEI_MAX_TTS', 'SRESoundEnd', 'SWPUnknownWordPronounceable',
    'DISPID_SVResume', 'DISPID_SPPNumberOfElements',
    'SAFT24kHz16BitMono', 'SVSFlagsAsync', 'SECFNoSpecialChars',
    'DISPIDSPTSI_ActiveOffset', 'SPPHRASEELEMENT',
    'SDKLDefaultLocation', 'SPPS_RESERVED3', 'SpObjectTokenCategory',
    'SRCS_Disabled', 'tagSPPROPERTYINFO', 'SpeechDataKeyLocation',
    'DISPID_SRCreateRecoContext', 'DISPID_SRCEHypothesis',
    'SPSHT_OTHER', 'DISPID_SDKDeleteValue', 'SLTUser',
    ...
    'ISpNotifyTranslator', 'SpeechRecoEvents', 'SPAO_NONE',
    'SPGRAMMARWORDTYPE', 'SSFMOpenReadWrite', 'ISpProperties',
    'DISPID_SRCEPropertyNumberChange', 'ISpEventSink', 'DISPID_SPPId',
    'DISPID_SRRAudioFormat', 'DISPID_SpeechPhraseAlternate',
    'IInternetSecurityManager', 'DISPID_SPRuleParent',
    'DISPID_SpeechRecoContextEvents', 'SPFILEMODE',
    'ISpObjectWithToken', 'SP_VISEME_18',
    'DISPID_SRCERecognizerStateChange', 'ISpeechRecognizerStatus',
    'SAFTExtendedAudioFormat', 'DISPID_SLAddPronunciation',
    'SITooQuiet', 'SpeechUserTraining', 'DISPID_SWFEExtraData',
    'SPEI_VOICE_CHANGE', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SDKEnumKeys', 'SAFT44kHz16BitMono',
    'SAFTADPCM_44kHzStereo', 'SPEI_ADAPTATION', 'SASClosed',
    'ISpeechGrammarRuleStateTransition', 'SPFM_NUM_MODES',
    'SpInProcRecoContext', 'DISPID_SMSAMMHandle', 'DISPID_SOTRemove',
    'SVEAudioLevel', 'ISpeechFileStream', 'DISPID_SPPValue',
    'ISpeechVoiceStatus', 'DISPID_SRRTimes', '__MIDL_IWinTypes_0009',
    'SPWORDPRONUNCIATIONLIST', 'SP_VISEME_1', 'SPSSuppressWord',
    'DISPID_SpeechPhraseProperties', 'DISPID_SpeechCustomStream',
    'ISpeechPhraseInfo', 'SAFT12kHz16BitStereo', 'DISPID_SPRulesItem',
    'DISPID_SRIsUISupported', 'eLEXTYPE_PRIVATE8',
    'SRTExtendableParse', 'DISPID_SLRemovePronunciationByPhoneIds',
    'eLEXTYPE_PRIVATE6', 'SVSFIsXML', 'SVEPrivate',
    'DISPID_SDKGetlongValue', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SpeechObjectTokenCategory', 'SpeechRecoProfileProperties',
    'ISpeechPhraseAlternates', 'DISPID_SRCRequestedUIType',
    'SPCT_SUB_COMMAND', 'DISPID_SRGRecoContext',
    'SDA_No_Trailing_Space', 'SGSDisabled', 'DISPID_SPILanguageId',
    'SVEViseme', 'STSF_FlagCreate', 'SAFTADPCM_11kHzStereo',
    'ISpStreamFormatConverter', 'SPCONTEXTSTATE', 'SRADynamic',
    'DISPID_SGRSTText', 'SP_VISEME_11', 'SSTTDictation',
    'SPPHRASEREPLACEMENT', 'ISpPhoneticAlphabetSelection',
    'SPBOOKMARKOPTIONS', 'SPLEXICONTYPE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPVOICESTATUS',
    'SpeechVoiceEvents', 'DISPID_SRGDictationUnload',
    'SVEEndInputStream', 'ISpeechPhoneConverter', 'ISequentialStream',
    'DISPID_SPPEngineConfidence', 'DISPID_SAFGuid',
    'SAFT16kHz8BitMono', 'SAFTCCITT_ALaw_44kHzMono', 'SRTSMLTimeout',
    'SpeechCategoryAudioOut', 'ISpeechObjectTokens', 'SPAR_Medium',
    'DISPID_SRIsShared', 'Speech_Max_Word_Length', 'SPPS_Unknown',
    'SPSVerb', 'SGPronounciation', 'DISPID_SVSLastBookmarkId',
    'SECLowConfidence', 'SRATopLevel', 'SPDKL_DefaultLocation',
    'SPWF_SRENGINE', 'SPRS_ACTIVE_USER_DELIMITED', 'ISpRecoResult',
    'SP_VISEME_10', 'ISpeechPhraseReplacements',
    'SREPropertyNumChange', 'SVEWordBoundary', 'SPEVENT',
    'SPGS_DISABLED', 'SREStateChange', 'SAFT11kHz8BitMono',
    'DISPID_SPRules_NewEnum', 'DISPID_SVEWord',
    'DISPID_SRRPhraseInfo', 'SVSFUnusedFlags', 'SP_VISEME_8',
    'eLEXTYPE_RESERVED7', 'DISPID_SGRSTWeight',
    'DISPID_SpeechDataKey', 'SPEI_TTS_BOOKMARK', 'SDTAlternates',
    'DISPID_SVRate', 'SPGS_EXCLUSIVE', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SOTCDefault', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRCCreateResultFromMemory',
    'SpeechPropertyComplexResponseSpeed', 'ISpShortcut',
    '_RemotableHandle', 'DISPID_SRCEventInterests', 'SPCS_DISABLED',
    'ISpAudio', 'SPSEMANTICFORMAT', 'SPSERIALIZEDPHRASE',
    'SpSharedRecognizer', 'eLEXTYPE_PRIVATE19', 'eLEXTYPE_PRIVATE4',
    'ISpMMSysAudio', 'SECNormalConfidence',
    'DISPID_SpeechGrammarRule', 'ISpRecoGrammar', 'SPBO_PAUSE',
    'SAFT48kHz16BitStereo', 'SpeechEmulationCompareFlags',
    'SPXRO_SML', 'SAFT48kHz8BitStereo', 'SPWORDLIST',
    ...
    'SGDSActiveUserDelimited', 'SPSInterjection',
    'DISPID_SASFreeBufferSpace', 'DISPID_SLPPartOfSpeech',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPCLangId',
    'ISpeechPhraseInfoBuilder', 'ISpPhrase', 'SRSEDone',
    'SRERequestUI', 'ISpRecoContext', 'SPPS_LMA', 'STCInprocHandler',
    'SVP_8', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SAVolume',
    'SPCT_DICTATION', 'SGDisplay', 'DISPID_SPRuleNumberOfElements',
    'ISpeechRecoResult', 'SPWT_DISPLAY',
    'SpeechPropertyResourceUsage', 'DISPIDSPTSI',
    'SpeechRecognitionType', 'ISpeechGrammarRuleState',
    'DISPID_SRCEFalseRecognition', 'eLEXTYPE_MORPHOLOGY', 'SPAR_Low',
    'SRTReSent', 'eLEXTYPE_APP', 'ISpStream',
    'DISPID_SPIAudioSizeTime', 'SP_VISEME_3',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPAStartElementInResult', 'SGDSActive',
    'eLEXTYPE_RESERVED6', 'DISPID_SVWaitUntilDone', 'SPPARTOFSPEECH',
    'SVEVoiceChange', 'SPRECOSTATE', 'ISpeechRecoResult2',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SVVolume',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechVoice', 'SRERecognition',
    'DISPID_SGRSTPropertyId', 'ISpeechLexiconWord', 'SLTApp',
    'DISPID_SRCPause', 'SpeechFormatType', 'DISPID_SABIBufferSize',
    'DISPID_SVSpeakStream', 'DISPID_SOTCategory', 'SBONone',
    'DISPID_SVSLastResult', 'DISPID_SRState', 'SpPhoneConverter',
    'SPFM_OPEN_READWRITE', 'SpeechCategoryVoices',
    'SpeechDiscardType', 'SPEI_RESERVED3', 'SAFTGSM610_22kHzMono',
    'SVSFParseSsml', 'ISpDataKey', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRRGetXMLErrorInfo', 'SPEI_SR_BOOKMARK',
    'DISPID_SRRAudio', 'ISpeechTextSelectionInformation', 'SITooSlow',
    'SP_VISEME_7', 'SVSFIsFilename', 'DISPID_SLGetWords',
    'SpeechCategoryPhoneConverters', 'SAFT22kHz8BitStereo',
    'SpObjectToken', 'SPEI_INTERFERENCE', 'ISpeechAudioStatus',
    'DISPID_SASState', 'DISPID_SPPParent', 'DISPID_SRCESoundStart',
    'ISpRecognizer', 'SpeechStreamFileMode', 'DISPID_SLPsCount',
    ...
    'DISPID_SVSyncronousSpeakTimeout', 'SWTDeleted', 'SPBO_NONE',
    'SVP_14', 'SWPUnknownWordUnpronounceable', 'DISPID_SLWsCount',
    'SVP_4', 'STSF_CommonAppData', 'ISpeechRecoGrammar',
    'DISPID_SOTGetAttribute', 'SPAUDIOSTATUS',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SGRInitialState', 'DISPID_SRCState', 'SVSFIsNotXML',
    'SVF_Stressed', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechLexiconPronunciation', 'SRAORetainAudio',
    'DISPID_SAEventHandle', 'SPRS_ACTIVE', 'SDTPronunciation',
    'SVPAlert', 'DISPID_SPPsCount', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SAFGetWaveFormatEx', 'SRESoundStart', 'ISpeechMMSysAudio',
    'DISPID_SRGetFormat', 'DISPID_SADefaultFormat',
    'DISPID_SVSVisemeId', 'SpeechAddRemoveWord', 'DISPID_SVGetVoices',
    'ISpeechRecognizer', 'SDTAll', 'DISPID_SGRsCommit',
    'ISpeechObjectToken', 'SpeechSpecialTransitionType',
    'SpeechLexiconType', 'SREAudioLevel', 'SSFMCreate', 'SVPNormal',
    'DISPID_SPELexicalForm', 'DISPID_SOTIsUISupported',
    'ISpeechGrammarRule', 'ISpeechAudioFormat', 'SDTReplacement',
    'SGRSTTWord', 'SpeechRetainedAudioOptions', 'DISPID_SPRText',
    'SAFT24kHz8BitStereo', 'DISPID_SRGCmdLoadFromObject',
    'SPEVENTSOURCEINFO', 'DISPID_SRGDictationLoad',
    'Speech_Max_Pron_Length', 'SPLO_DYNAMIC', 'SPVPRI_OVER',
    'DISPID_SRGCommit', 'DISPID_SPPName', 'DISPID_SBSRead',
    'DISPID_SPRsItem', 'SVP_19', 'SPSNotOverriden',
    '_ISpeechVoiceEvents', 'DISPID_SPAPhraseInfo', 'SPEI_TTS_PRIVATE',
    ...
    'DISPID_SGRsDynamic', 'SVP_11', 'DISPID_SpeechPhraseReplacements',
    'SpeechDictationTopicSpelling', 'DISPID_SVAudioOutput',
    'DISPID_SLWs_NewEnum', 'SpFileStream',
    ...
    'SPWF_INPUT', 'DISPID_SRRDiscardResultInfo', 'DISPID_SPRuleId',
    'DISPID_SVEVoiceChange', 'DISPID_SLPSymbolic',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SOTSetId',
    'ISpeechWaveFormatEx', 'SPCT_COMMAND', 'SpeechCategoryAudioIn',
    'SAFT32kHz16BitMono', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SAFTTrueSpeech_8kHz1BitMono', 'SVP_18', 'SGRSTTDictation',
    'SPPHRASEPROPERTY', 'ISpeechRecoResultTimes',
    'SpeechAudioFormatGUIDText', 'DISPID_SPRNumberOfElements',
    'DISPID_SpeechLexiconWords', 'DISPID_SVGetProfiles', 'SVP_16',
    'SINoise', 'SVP_21', 'DISPIDSPRG', 'DISPID_SpeechLexicon',
    'SPEI_PHRASE_START', 'SSTTTextBuffer', 'SAFTADPCM_22kHzStereo',
    'SAFTADPCM_8kHzStereo', 'SpeechCategoryAppLexicons',
    'SpNotifyTranslator', 'SPEI_MIN_TTS', 'SECFIgnoreCase',
    'eLEXTYPE_USER', 'SpeechTokenKeyUI', 'ISpeechPhraseAlternate',
    'SPCS_ENABLED', 'SASPause', 'DISPID_SOTDisplayUI',
    'SPEI_HYPOTHESIS', 'SAFT22kHz8BitMono', 'DISPID_SpeechPhraseInfo',
    'ISpeechLexiconPronunciation', 'SREPropertyStringChange',
    'DISPID_SPPFirstElement', 'SpeechGrammarState', 'SRARoot',
    'DISPID_SRCSetAdaptationData', 'SRTStandard', 'SRAONone',
    'LONG_PTR', 'SpCustomStream', 'SPINTERFERENCE_NOISE',
    'SPAS_CLOSED', 'ISpeechPhraseReplacement', 'SPDKL_LocalMachine',
    'SAFT44kHz8BitMono', 'SVSFPurgeBeforeSpeak', 'SPAO_RETAIN_AUDIO',
    'DISPID_SRSClsidEngine', 'DISPID_SRGIsPronounceable',
    'SpeechTokenIdUserLexicon', 'DISPID_SGRId', 'DISPID_SGRsItem',
    'STCRemoteServer', 'SPFM_OPEN_READONLY', 'SP_VISEME_12', 'SVP_1',
    'DISPID_SRRTTickCount', 'DISPID_SVStatus', 'SPPS_Noncontent',
    'SPEI_MAX_SR', 'DISPID_SPAsItem', 'SDTLexicalForm', 'SVEPhoneme',
    'SPEI_END_INPUT_STREAM', 'SSSPTRelativeToStart', 'SVP_0',
    'SSFMCreateForWrite', 'DISPID_SVAudioOutputStream', 'SpMMAudioIn',
    'ISpeechGrammarRules', 'SpPhoneticAlphabetConverter',
    'SAFT32kHz8BitStereo', 'DISPID_SpeechXMLRecoResult',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPEVENTENUM', 'ISpStreamFormat',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVPriority',
    'DISPID_SLPType', 'DISPID_SRCEStartStream', 'SVP_9',
    'DISPID_SGRSRule', 'ISpPhraseAlt', 'DISPID_SRSetPropertyNumber',
    'SpNullPhoneConverter', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCAudioInInterferenceStatus', 'SPPS_Function',
    'DISPID_SVSInputSentenceLength', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPIGetText', 'SGSExclusive', 'SPAUDIOSTATE',
    'DISPIDSPTSI_SelectionLength', 'SRSActive', 'SREFalseRecognition',
    'SpTextSelectionInformation', 'SFTSREngine', 'SVP_17',
    'SAFTGSM610_11kHzMono', 'SPPS_SuppressWord',
    'SDA_Consume_Leading_Spaces', 'SpeechTokenContext',
    'DISPID_SLWLangId', 'SPCT_SLEEP', 'SPXRO_Alternates_SML',
    'DISPID_SpeechRecoResult2', 'SPSHT_NotOverriden', 'SpStream',
    'DISPID_SLPPhoneIds', 'DISPID_SWFEBlockAlign', 'SpAudioFormat',
    'DISPID_SRGetPropertyNumber', 'UINT_PTR', 'SpeechAudioVolume',
    'SAFT22kHz16BitStereo', 'DISPID_SWFESamplesPerSec',
    'DISPID_SGRsFindRule', 'SGRSTTTextBuffer', 'SPLOADOPTIONS',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRRGetXMLResult', 'DISPID_SVSpeak',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechRecoResult',
    'DISPID_SVSLastStreamNumberQueued', 'ISpEventSource',
    'DISPID_SPEs_NewEnum', 'SASRun',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SLWType',
    'DISPID_SRCVoice', 'DISPID_SOTsItem', 'SWTAdded',
    'DISPID_SLPLangId', 'IEnumSpObjectTokens', 'SpMMAudioEnum',
    'SASStop', 'ISpeechDataKey', 'SpeechPropertyResponseSpeed',
    'SpeechEngineConfidence', 'DISPID_SGRSTNextState',
    'SpeechTokenShellFolder', 'SPEI_SOUND_START',
    'SpeechVoiceSkipTypeSentence', 'SBOPause', 'SGRSTTRule',
    'eLEXTYPE_RESERVED8', 'SPWORDTYPE', 'SVSFParseMask',
    'SPRST_ACTIVE', 'SRERecoOtherContext', 'SP_VISEME_14',
    'SPVPRI_NORMAL', 'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPCPhoneToId',
    'DISPID_SPIReplacements', 'SpStreamFormatConverter',
    'SPDKL_CurrentUser', 'ISpSerializeState', 'SPVPRIORITY',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPAR_High', 'ISpeechAudio',
    'DISPID_SLPs_NewEnum', 'SSFMOpenForRead',
    'DISPID_SpeechLexiconWord', 'SP_VISEME_20', 'SAFT48kHz8BitMono',
    'SPPS_NotOverriden', 'SAFT12kHz8BitMono', 'SpeechAudioFormatType',
    'SPAUDIOBUFFERINFO', 'DISPID_SOTCreateInstance',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechPropertyLowConfidenceThreshold',
    'ISpXMLRecoResult', 'DISPID_SPRuleChildren',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechFileStream',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_RESERVED9',
    'DISPID_SPIGrammarId', 'SPINTERFERENCE_NOSIGNAL',
    'SAFT22kHz16BitMono', 'SP_VISEME_2', 'DISPID_SRGRules',
    'SVSFNLPMask', 'SpeechCategoryRecoProfiles',
    'DISPID_SPRDisplayAttributes', 'DISPID_SMSGetData',
    'SAFTCCITT_uLaw_22kHzMono', 'SPWT_LEXICAL', 'SP_VISEME_4',
    ...
    'DISPID_SLRemovePronunciation', 'DISPID_SPEActualConfidence',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SFSOpen',
    'tagSPTEXTSELECTIONINFO', 'SpeechRecognizerState', 'SRCS_Enabled',
    'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SVSkip',
    'SpeechAllElements', 'DISPID_SpeechObjectTokens',
    'DISPID_SPAs_NewEnum', 'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE13',
    'SPEI_SR_PRIVATE', 'SPCT_SUB_DICTATION',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSTPropertyValue',
    'ISpPhoneticAlphabetConverter', 'DISPID_SPRulesCount',
    'DISPID_SWFEChannels', 'eWORDTYPE_DELETED',
    'DISPID_SPEPronunciation', 'SPINTERFERENCE_TOOFAST', 'SDTRule',
    'DISPID_SRCERecognition', 'SP_VISEME_6', 'SPPS_Modifier',
    'Speech_Default_Weight', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpeechWordType', 'SpeechPartOfSpeech', 'SPAS_PAUSE',
    'SPEI_RESERVED2', 'SPEI_MIN_SR', 'SPWT_PRONUNCIATION',
    'SpUnCompressedLexicon', 'DISPID_SRRSetTextFeedback',
    'DISPID_SGRs_NewEnum', 'SP_VISEME_16',
    'DISPID_SpeechPhraseReplacement', 'SpeechTokenKeyFiles',
    'ISpeechBaseStream', 'DISPID_SRGReset', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SGRSTType', 'DISPID_SASCurrentSeekPosition',
    'SDTProperty', 'SpeechInterference', 'SAFT16kHz16BitStereo',
    'SAFT44kHz8BitStereo', 'DISPID_SRCEBookmark', 'SVSFNLPSpeakPunc',
    'SAFT8kHz16BitStereo', 'DISPID_SRGetPropertyString',
    'SPVPRI_ALERT', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRRSaveToMemory', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVVoice', 'DISPID_SPERetainedSizeBytes',
    'eWORDTYPE_ADDED', 'SAFTCCITT_ALaw_22kHzMono', 'SPPS_RESERVED2',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SVSRunningState',
    'ISpRecoCategory', 'DISPID_SLWsItem', 'DISPID_SOTsCount',
    'SPEI_RESERVED1', 'SP_VISEME_13', 'SAFTADPCM_22kHzMono',
    'SREAdaptation', 'DISPID_SDKEnumValues',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCRetainedAudioFormat',
    'SPINTERFERENCE_NONE', 'SPEI_RECOGNITION', 'SVPOver',
    'ISpObjectToken', 'SpeechBookmarkOptions', 'SVP_3',
    'SGRSTTWildcard', 'SPPS_Interjection',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPACommit',
    'SPSHORTCUTPAIRLIST', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPPChildren', 'SPDATAKEYLOCATION', 'DISPID_SVSPhonemeId',
    'SPRS_INACTIVE', 'SpVoice', 'SPBO_AHEAD', 'SRAExport',
    'WAVEFORMATEX', 'SRSActiveAlways', 'SAFT8kHz16BitMono',
    'DISPID_SRCEEndStream', 'SAFTADPCM_11kHzMono', 'ISpNotifySource',
    'SRSInactive', 'DISPID_SASetState', 'STSF_LocalAppData',
    'DISPID_SPARecoResult', 'ISpeechCustomStream',
    'SPWORDPRONUNCIATION', 'SRADefaultToActive', 'SREInterference',
    'SRSEIsSpeaking', 'DISPID_SRRecognizer', 'SDKLCurrentConfig',
    'SPAS_RUN', 'ISpObjectTokenCategory', 'SECHighConfidence',
    'DISPID_SPRFirstElement', 'DISPID_SABufferInfo',
    'DISPID_SGRClear', 'SP_VISEME_21', 'DISPID_SpeechBaseStream',
    'SRAImport', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'eLEXTYPE_PRIVATE3', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechGrammarWordType', 'DISPID_SAFType',
    'DISPID_SOTMatchesAttributes', 'DISPID_SBSSeek', 'SFTInput',
    'SAFTNoAssignedFormat', 'DISPID_SpeechPhraseProperty',
    'SpeechAudioFormatGUIDWave', 'SGRSTTEpsilon',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVESentenceBoundary',
    'SPEI_VISEME', 'SAFT8kHz8BitStereo',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRCRetainedAudio',
    'DISPID_SRGId', 'STCAll', 'Speech_StreamPos_RealTime',
    'SpSharedRecoContext', 'SVSFDefault', 'DISPID_SLPsItem',
    'SAFT32kHz8BitMono', 'DISPID_SOTId', 'SAFT32kHz16BitStereo',
    'DISPID_SVSInputWordPosition', 'SVP_20', 'SPWAVEFORMATTYPE',
    'DISPID_SVEAudioLevel', 'DISPID_SPIProperties',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SOTCId',
    'SAFT12kHz16BitMono', 'DISPID_SGRSTRule',
    'DISPID_SWFEBitsPerSample', 'SPAUDIOOPTIONS'
]
